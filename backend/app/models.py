...
class CandidateCard(Base):
    ...
    candidate_context = Column(Text, nullable=True)
    candidate_context_file_key = Column(String(255), nullable=True)
    candidate_context_file_name = Column(String(255), nullable=True)
